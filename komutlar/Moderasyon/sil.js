...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('sil')
        .setDescription('Sohbette istediğin kadar mesajı siler.')
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.ManageMessages)) {
            const noPermissionEmbed = new EmbedBuilder()
                .setDescription('<:rei_x:1218821747751522334> | Mesajları Yönetme Yetkin Yok!')
            .setColor("Red")
        ...
        try {
            ...
            const successEmbed = new EmbedBuilder()
                .setTitle('Başarılı')
                .setColor("Green")
                .setDescription(` <:rei_on:1218821744639348776> | ${count} adet mesaj başarıyla silindi.`)
